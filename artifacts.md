...
| [Tööst olenevad ohutegurid](StructureDefinition-ee-health-certificate-work-related-risk-factor.md) | Observation ressurss mis kirjeldab tööst olenevad ohutegurid. Kasutatud contained ressurisina. |
...
| | |
| :--- | :--- |
| [Mootosõidukijuhi tervisetõend kasutusala](ValueSet-ee-health-certificate-driver-category.md) | Tervisetõend kasutusala mis on mõeldud kasutamiseks mootosõidukijuhi tervisetõendis |
| [Tervisetõendi staatus](ValueSet-ee-health-certificate-status.md) | Staatuste loend millega opereerib HCERT teenus |
