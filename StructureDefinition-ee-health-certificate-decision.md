# Otsus - Tervisetõendi teenus (HCERT) v1.0.0

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **Otsus**

## Resource Profile: Otsus 

| | |
| :--- | :--- |
| *Official URL*:https://fhir.ee/hcert/StructureDefinition/ee-health-certificate-decision | *Version*:1.0.0 |
| Active as of 2026-03-11 | *Computable Name*:EEHealthCertificateDecision |

 
Observation ressurss mis kirjeldab otsuse. Kasutatud contained ressurisina 
