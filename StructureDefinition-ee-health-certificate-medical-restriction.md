# Meditsiiniline piirang - Tervisetõendi teenus (HCERT) v1.0.0

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **Meditsiiniline piirang**

## Resource Profile: Meditsiiniline piirang 

| | |
| :--- | :--- |
| *Official URL*:https://fhir.ee/hcert/StructureDefinition/ee-health-certificate-medical-restriction | *Version*:1.0.0 |
| Active as of 2026-03-11 | *Computable Name*:EEHealthCertificateMedicalRestriction |
