...
| Active as of 2025-11-19 | *Computable Name*:EEHealthCertificateSuspend |

 
Tervisetõendi peatamise operatsioon 

URL: [base]/Composition/[id]/$suspend
...
* **Use**: OUT
  ...
  * **Scope**: 
  * **Cardinality**: 1..1
  * **Type**: [Composition](http://hl7.org/fhir/R5/composition.html)
  * **Binding**: 
