...
| Active as of 2026-03-11 | *Computable Name*:EEHealthCertificateOccupational |
...
```json
{
  ...
  "differential" : {
    ...
    },
    {
      ...
      "type" : [{
        "code" : "Observation",
        "profile" : ["https://fhir.ee/hcert/StructureDefinition/ee-health-certificate-work-related-risk-factor"]
      }]
    },
    {
      ...
      "type" : [{
        "code" : "Observation",
        "profile" : ["https://fhir.ee/hcert/StructureDefinition/ee-health-certificate-occupational-employment"]
      }]
    },
    {
      ...
      "type" : [{
        "code" : "Observation",
        "profile" : ["https://fhir.ee/hcert/StructureDefinition/ee-health-certificate-work-additional-condition"]
      }]
    },
    {
    ...
    },
    {
      ...
      "type" : [{
        "code" : "Reference",
        "targetProfile" : ["https://fhir.ee/hcert/StructureDefinition/ee-health-certificate-work-related-risk-factor"]
      }]
    },
    {
    ...
    },
    {
      ...
      "type" : [{
        "code" : "Reference",
        "targetProfile" : ["https://fhir.ee/hcert/StructureDefinition/ee-health-certificate-occupational-employment"]
      }]
    },
    {
    ...
    },
    {
      ...
      "type" : [{
        "code" : "Reference",
        "targetProfile" : ["https://fhir.ee/hcert/StructureDefinition/ee-health-certificate-work-additional-condition"]
      }]
    },
    {
