...
| hcert.driver-certificate.read | gov-official | Mootorsõiduki juhtimise kinnitatud tõendite lugemine | GET /fhir/Composition?category=driver-group-I&status=final,cancelledGET /fhir/Composition?category=driver-group-I,driver-group-II&status=final,cancelledGET /fhir/Composition/{id}, kus category=driver-group-I,driver-group-II&status=final,cancelled |
