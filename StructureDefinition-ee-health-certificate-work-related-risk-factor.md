# Tööst olenevad ohutegurid - Tervisetõendi teenus (HCERT) v1.0.0

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **Tööst olenevad ohutegurid**

## Resource Profile: Tööst olenevad ohutegurid 

| | |
| :--- | :--- |
| *Official URL*:https://fhir.ee/hcert/StructureDefinition/ee-health-certificate-work-related-risk-factor | *Version*:1.0.0 |
| Active as of 2025-11-19 | *Computable Name*:EEHealthCertificateWorkRelatedRiskFactor |
  ...
  "differential" : {
    "element" : [
      ...
      },
      {
        ...
        "binding" : {
          "strength" : "required",
          "valueSet" : "https://fhir.ee/ValueSet/toost-olenevad-ohutegurid"
        }
      },
      {
        "id" : "Observation.note",
